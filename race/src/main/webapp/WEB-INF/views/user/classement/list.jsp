                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row g-4 mb-3">
                                    <form action="/user/classement/list" method="get">
                                        <div class="d-flex">
                                            <div class="me-1">
                            ...
                            <div class="live-preview">
                                ...
                                <div class="table-responsive modal-body-pdf">
                                    <table class="table align-middle table-nowrap mb-0" id="myTable">
                                        <thead>
                                            <tr>
                                                <th scope="col">Rang <a href="/user/classement/list?column=rang&sort=<%= (sort+1) %>"><i class="ri-expand-up-down-line" style="float: right;"></i></a></th>
                                                <th scope="col">Coureur <a href="/user/classement/list?column=nom_coureur&sort=<%= (sort+1) %>"><i class="ri-expand-up-down-line" style="float: right;"></i></a></th>
                                                <th scope="col">Equipe <a href="/user/classement/list?column=id_equipe&sort=<%= (sort+1) %>"><i class="ri-expand-up-down-line" style="float: right;"></i></a></th>
                                                <th scope="col">Point <a href="/user/classement/list?column=total_points&sort=<%= (sort+1) %>"><i class="ri-expand-up-down-line" style="float: right;"></i></a></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                ...
                                <div class="d-flex justify-content-end">
                                    <div class="pagination-wrap hstack gap-2">
                                        <a class="page-item pagination-prev <%= noPage == 1 ? "disabled" : "" %>"
                                            href="<%= noPage == 1 ? "#" : "/user/classement/list?noPage=" + (noPage - 1) %>"
                                            <%= noPage == 1 ? "disabled" : "" %>>
                                            Previous
                                        </a>
                                        <ul class="pagination mb-0 listjs-pagination">
                                        <% for (int i = 1; i <= totalPages; i++) { %>
                                            <li <% if (i == noPage) { %>class="active"<% } %>><a class="page" href="/user/classement/list?noPage=<%= i %>"><%= i %></a></li>
                                        <% } %></ul>
                                        <a class="page-item pagination-next <%= noPage == totalPages ? "disabled" : "" %>"
                                            href="<%= noPage == totalPages ? "#" : "/user/classement/list?noPage=" + (noPage + 1) %>"
